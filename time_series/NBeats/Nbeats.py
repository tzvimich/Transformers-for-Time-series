...
def run(X_train, y_train, X_test, y_test, horizon, blocks=8, hidden_layer_dim=64):
    ...
    Model.fit(X_train, y_train, batch_size=128, epochs=100, verbose=2, validation_split=0.15, callbacks=[callback])
...
if __name__=="__main__":
    ...
    for hidden_dim in [64, 128, 256, 512, 1024, 2048]:
        blocks=40
        print("Hidden dim: ", hidden_dim)
        print("Number of blocks: ", blocks)
        run(X_train, y_train, X_test, y_test, horizon, blocks=blocks, hidden_layer_dim=hidden_dim)
