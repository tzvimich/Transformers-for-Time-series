...
if __name__=="__main__":
    ...
    lst = [(10, 1, 12, 12, SAMPLE_SIZE*4, learning_rate, SAMPLE_SIZE, True, True),
           (12, 1, 12, 12, SAMPLE_SIZE*4, learning_rate, SAMPLE_SIZE, True, True),
           (14, 1, 12, 12, SAMPLE_SIZE*4, learning_rate, SAMPLE_SIZE, True, True),
           (16, 1, 12, 12, SAMPLE_SIZE*4, learning_rate, SAMPLE_SIZE, True, True)]
